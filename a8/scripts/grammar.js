...
yy: {},
symbols_: {"error":2,"program":3,"exp":4,"EOF":5,"var_exp":6,"intlit_exp":7,"fn_exp":8,"app_exp":9,"prim1_app_exp":10,"prim2_app_exp":11,"if_exp":12,"let_exp":13,"lets_exp":14,"print_exp":15,"print2_exp":16,"assign_exp":17,"VAR":18,"INT":19,"PRINT":20,"DQUOTE":21,"optional":22,"COLON":23,"SET":24,"EQ":25,"block":26,"SEMICOLON":27,"LET":28,"bindings":29,"IN":30,"END":31,"LETS":32,"FN":33,"LPAREN":34,"formals":35,"RPAREN":36,"THATRETURNS":37,"moreformals":38,"COMMA":39,"args":40,"prim1_op":41,"prim2_op":42,"ADD1":43,"NEG":44,"NOT":45,"PLUS":46,"MINUS":47,"TIMES":48,"DIV":49,"REM":50,"LT":51,"GT":52,"prim_args":53,"more_prim_args":54,"IF":55,"THEN":56,"ELSE":57,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",18:"VAR",19:"INT",20:"PRINT",21:"DQUOTE",23:"COLON",24:"SET",25:"EQ",27:"SEMICOLON",28:"LET",30:"IN",31:"END",32:"LETS",33:"FN",34:"LPAREN",36:"RPAREN",37:"THATRETURNS",39:"COMMA",43:"ADD1",44:"NEG",45:"NOT",46:"PLUS",47:"MINUS",48:"TIMES",49:"DIV",50:"REM",51:"LT",52:"GT",55:"IF",56:"THEN",57:"ELSE"},
...
rules: [/^(?:\s+)/,/^(?:fn\b)/,/^(?:\()/,/^(?:\))/,/^(?:\+)/,/^(?:\*)/,/^(?:\/)/,/^(?:%)/,/^(?:-)/,/^(?:<)/,/^(?:>)/,/^(?:===)/,/^(?:~)/,/^(?:not\b)/,/^(?:add1\b)/,/^(?:let\b)/,/^(?:lets\b)/,/^(?:in\b)/,/^(?:end\b)/,/^(?:print\b)/,/^(?:set\b)/,/^(?:;)/,/^(?::)/,/^(?:,)/,/^(?:=>)/,/^(?:if\b)/,/^(?:then\b)/,/^(?:else\b)/,/^(?:=)/,/^(?:")/,/^(?:$)/,/^(?:([a-zA-Z])(([a-zA-Z])|([0-9])|_)*)/,/^(?:([0-9])+)/,/^(?:.)/],
