...
function createLetsExp(bindings, body) {
    return ["LetsExp", bindings, body];
}
function isLetsExp(e) { 
    return e[0] === "LetsExp"; 
}
function getLetsExpBindings(e) { 
    if (isLetsExp(e)) {
	return e[1];
    } else {
	throw new Error("Interpreter error: "  +
			"The argument of getLetsExp is not an LetsExp.");
    }
}
function getLetsExpBody(e) { 
    if (isLetsExp(e)) {
	return e[2]; 
    } else {
	throw new Error("Interpreter error: "  +
			"The argument of getLetsExpBody is not an LetsExp.");
    }
}
function createLetmrExp(vars, bodies, block) {
    return ["LetmrExp", vars, bodies, block];
}
function isLetmrExp(e) { 
    return e[0] === "LetmrExp"; 
}
function getLetmrExpVars(e) { 
    if (isLetmrExp(e)) {
	return e[1];
    } else {
	throw new Error("Interpreter error: "  +
			"The argument of getLetmrExpVars is not an LetmrExp.");
    }
}
function getLetmrExpBodies(e) { 
    if (isLetmrExp(e)) {
	return e[2]; 
    } else {
	throw new Error("Interpreter error: "  +
			"The argument of getLetmrExpBodies is not an LetmrExp.");
    }
}
...
exports.getLetsExpBody = getLetsExpBody;
exports.createLetmrExp = createLetmrExp;
exports.isLetmrExp = isLetmrExp;
exports.getLetmrExpVars = getLetmrExpVars;
exports.getLetmrExpBodies = getLetmrExpBodies;
